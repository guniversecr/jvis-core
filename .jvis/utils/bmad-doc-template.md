...
# JVIS Document Template Specification

## Overview

JVIS document templates are defined in YAML format to drive interactive document generation and agent interaction. Templates separate structure definition from content generation, making them both human and LLM-agent-friendly.
...
- **workflow.mode**: Default interaction mode ("interactive" or "batch")
